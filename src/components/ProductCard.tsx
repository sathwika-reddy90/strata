      ...
      <div className="group">
        <div className="relative aspect-[4/5] overflow-hidden bg-stone-100">
          ...
          <div className="absolute inset-0 flex items-end bg-gradient-to-t from-ink/70 via-transparent to-transparent opacity-0 transition-opacity duration-400 group-hover:opacity-100">
            <span className="p-5 text-xs font-semibold uppercase tracking-[0.14em] text-warm-white">
              View Details &#8594;
            </span>
          </div>
          {product.featured && (
            <span className="absolute left-4 top-4 bg-ink px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.18em] text-warm-white">
              Featured
            </span>
          )}
        </div>
        <div className="mt-4">
          ...
          <h3 className="mt-1 text-lg text-ink">{product.name}</h3>
